    ...
    <>
      ...
      <section className="relative py-20">
        ...
        <div className="max-w-2xl mx-auto p-4">
          <div className="aspect-w-16 aspect-h-9 rounded">
            <img className="w-full h-full object-cover rounded-lg" src="atis-assets/hero.png" alt="" />
          </div>
        </div>
      ...
      <section className="pb-20">
        <div className="container mx-auto px-4 text-center">
          <h3 className="mb-10 text-2xl font-heading">As seen on</h3>
      ...
      <section className="pb-20">
        <div className="container px-4 mx-auto">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="mb-6 text-xl text-justify">If you want to monetize your audience and launch your first workshop, course or community, and make more than ₹50,000 worth of sales converting your followers, then read ahead:</p>
            <p className="mb-6 text-xl text-justify font-bold">Here&apos;s an offer you cannot refuse:</p>
            <p className="mb-6 text-xl text-justify">I&apos;m looking for creators who have just started or have NOT monetized their audience on social media or elsewhere using workshops, courses or a paid community</p>
            <p className="mb-6 text-xl text-justify">OR coaches, trainers, consultants who are struggling to scale their service based offerings.</p>
            <p className="mb-6 text-xl text-justify">I have great news for you!</p>
            <p className="mb-6 text-xl text-justify">Today, I&apos;m going to GIVE YOU A 99.99% “Done-For-You” Approach on doing just that!</p>
            ...
            <p className="mb-6 text-xl text-center font-bold">Absolutely FREE!</p>
            ...
            <p className="mb-6 text-xl">In just a moment I&apos;m going to “demystify” everything you&apos;ve been told about starting and growing a money making machine online.</p>
            <p className="mb-6 text-xl">As well as show you, the exact step-by-step guide on how to launch a workshop, course or community for which people will not only pay you, but spread the word themselves and bring more audience for you!</p>
            <p className="mb-6 text-xl">Now, you might be wondering</p>
            <p className="mb-6 text-xl">“Why is Shashwat being so generous and doing all this for FREE, what is in it for him?”</p>
            <p className="mb-6 text-xl">Well, there&apos;s no point in beating around the bush</p>
            <p className="mb-6 text-xl">Quite simply, I want you to STOP PROCRASTINATING and START OPERATING LIKE A BUSINESS</p>
            <p className="mb-6 text-xl">And, to become an evangelist for my STEP-BY-STEP Secrets for others in your circle.</p>
            <p className="mb-6 text-xl text-justify font-bold">Sounds fair?</p>
            <p className="mb-6 text-xl">I just want you to promise one thing, that if my methods work for you, then you will share it with 5 of your friends, who this makes ABSOLUTE sense for.</p>
            <p className="mb-6 text-xl text-justify font-bold">Deal?</p>
            <p className="mb-6 text-xl">But before that! I know this is NOT A JOKE, and there&apos;s only 100 people that I can help through this challenge.</p>
            <p className="mb-6 text-xl">If you have doubts on whether you can do this, or you DO NOT consider yourself as a creator, trainer, coach or expert. Then PLEASE STOP! This is probably not for you.</p>
            <p className="mb-6 text-xl">And if, all of that is NOT TRUE, and you really want to make REAL MONEY off of things that you LOVE doing, then go ahead and REGISTER for the FREE WORKSHOP, where I&apos;ll personally help you in LAUNCHING your own workshop, course and community to start your monetization journey!</p>
            <p className="mb-6 text-xl">To date, Kohbee has helped over 200,000 creators in setting this up for themselves and transitioning from being <b>a creator to an entrepreneur.</b></p>
          </div>
        </div>
      </section>
            ...
            <div className="hidden lg:block absolute top-0 left-0 lg:w-1/3 px-3 -ml-80 opacity-25">
              <div className="p-8 bg-white rounded shadow text-center">
                <div className="bg-no-repeat bg-left-top">
                  ...
                  <img className="mb-2 mx-auto w-12 h-12 rounded-full object-cover" src="" alt="" />
              ...
              <div className="mb-4 w-full lg:w-1/3 px-3">
                <div className="p-8 bg-white rounded shadow text-center">
                  <div className="bg-no-repeat bg-left-top">
                    ...
                    <img className="mb-2 mx-auto w-12 h-12 rounded-full object-cover" src="atis-assets/testimonials/testimonial1.png" alt="" />
                    <h4 className="mb-1 text-2xl font-bold font-heading">Sneha Kewalramani</h4>
                    <p className="text-gray-500">Skincare Specialist</p>
                  </div>
                </div>
              ...
              <div className="mb-4 w-full lg:w-1/3 px-3">
                <div className="p-8 bg-white rounded shadow text-center">
                  <div className="bg-no-repeat bg-left-top">
                    ...
                    <img className="mb-2 mx-auto w-12 h-12 rounded-full object-cover" src="atis-assets/testimonials/testimonial2.png" alt="" />
              ...
              <div className="mb-4 w-full lg:w-1/3 px-3">
                <div className="p-8 bg-white rounded shadow text-center">
                  <div className="bg-no-repeat bg-left-top">
                    ...
                    <img className="mb-2 mx-auto w-12 h-12 rounded-full object-cover" src="atis-assets/testimonials/testimonial3.png" alt="" />
