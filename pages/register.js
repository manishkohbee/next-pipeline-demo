...
export default function Register() {
    ...
    if (hasSubmitted === null)
        return (
            <section className="">
                <div className="flex items-center justify-center h-screen mx-auto max-w-2xl">
                    <form className=" rounded-xl mx-4 p-4">
                        <h3 className="mb-10 text-3xl lg:text-4xl text-center font-bold">You are just one step away from growing your revenue online</h3>
                        <div className="mb-6">
                        ...
                        <div className="flex justify-center">
                            <button disabled={isSubmitting} className="mt-4 py-2 px-6 rounded bg-primary text-white font-bold leading-loose transition duration-200">REGISTER</button>
                        </div>
                    </form>
                </div>
            </section>
