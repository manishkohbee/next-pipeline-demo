        ...
        return (
            <section className="">
                <div className="flex items-center justify-center h-screen mx-auto max-w-xl">
                    <div className="">
                        <form onSubmit={handleSubmit} className="bg-overlaay rounded-xl mx-4 px-4 py-4">
                            ...
                            <div className="mb-6">
                                <input className="h-16 w-full p-4 text-l font-semibold leading-none rounded outline-none bg-kohbeeblack" type="text" placeholder="Name" required value={name} onChange={(e) => setName(e.target.value)} />
                            </div>
                            <div className="mb-6">
                                <input className="h-16 w-full p-4 text-l font-semibold leading-none rounded outline-none bg-kohbeeblack" type="email" placeholder="Email" required value={email} onChange={(e) => setEmail(e.target.value)} />
                            </div>
                            <div className="mb-6">
                                <input className="h-16 w-full p-4 text-l font-semibold leading-none rounded outline-none bg-kohbeeblack" type="number" placeholder="Phone (without 0 or +91)" required maxLength={10} minLength={10} value={phone} onChange={(e) => setPhone(e.target.value)} />
                            </div>
            ...
            <section>
                <div className="flex items-center justify-center h-screen mx-auto max-w-xl">
                    <div className="grid grid-cols-1 gap-4">
                        ...
                        <a target="_blank" href="https://bit.ly/3AhX7D6" type="button" className="my-2 py-2 px-6 rounded bg-[#4284f3] text-white font-medium leading-loose transition duration-200 inline-flex items-center" rel="noreferrer">
                        ...
                        <a target="_blank" href="https://bit.ly/3SMgpaL" type="button" className="mb-2 py-2 px-6 rounded bg-[#25D366] text-white font-medium leading-loose transition duration-200 inline-flex items-center" rel="noreferrer">
